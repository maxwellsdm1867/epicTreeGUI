classdef graphicalTreeNodeWidget < handle
    ...
    %
    % Each widget can be bound/unbound to different graphicalTreeNode objects
    ...
    methods
        function self = graphicalTreeNodeWidget(tree)
            ...
            %
            % Usage:
            %   widget = graphicalTreeNodeWidget(tree)
        ...
        function buildWidgets(self)
            ...
            self.expandBox.callback = {@graphicalTreeNodeWidget.expanderCallback, self.selfKey, gTree};
            ...
            self.checkBox.callback = {@graphicalTreeNodeWidget.checkboxCallback, self.selfKey, gTree};
        end
